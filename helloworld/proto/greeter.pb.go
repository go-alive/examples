...
// source: github.com/go-alive/examples/helloworld/proto/greeter.proto
...
func init() {
	proto.RegisterFile("github.com/go-alive/examples/helloworld/proto/greeter.proto", fileDescriptor_f59dc6c921369088)
}
